...
public class Database extends SQLiteOpenHelper {
	...
	// Created an instance on Element class here, so both of the
	// below methods can access it.
	Element element = new Element();

	// This method simply queries the database for a particular element, gets
	// all the information, and uses that information to create an instance of
	// the Element class. Through the getters, the information is then obtained
